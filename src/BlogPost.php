...
use BlogPage\Content\Blog\BlogEntriesDefinition;
use BlogPage\Content\Blog\BlogSeoUrlRoute;
use BlogPage\Content\Blog\Events\BlogIndexerEvent;
use BlogPage\Util\Lifecycle;
use BlogPage\Util\Update;
...
class BlogPage extends Plugin
{
    ...
    public function uninstall(UninstallContext $context): void
    {
        ...
        $connection->executeStatement('DROP TABLE IF EXISTS `blog_entries`');
        $connection->executeStatement('DROP TABLE IF EXISTS `blog_entries_translation`');
    ...
    private function deleteSeoUrlTemplate(Context $context): void
    {
        $criteria = new Criteria();
        $criteria->addFilter(
            new EqualsFilter('entityName', 'blog_entries')
        );
